(function (global, factory) {
	...
	var script = {
	    ...
	    methods: {
	        ...
	        init: function init() {
	            ...
	            var container = this.$el.querySelector('[data-croppie="container"]') || this.$el;

	            container.addEventListener('update', function (event) {
	                _this.$emit('update', event.detail);
	            });

	            this.croppie = new croppie_1(container, this.options);
	        },
	        reset: function reset() {
	            this.destroy();
	            this.init();
	        },
	        result: function result(options, callback) {
	            var _this2 = this;
	    ...
	    render: function render(createElement) {
	        ...
	        if (this.$scopedSlots.default !== undefined) {
	            dataAttributes = [this.$scopedSlots.default({
	                bind: this.bind,
	...
	var component = __vue_normalize__({}, __vue_inject_styles__, __vue_script__, __vue_scope_id__, __vue_is_functional_template__, __vue_module_identifier__, __vue_create_injector__, undefined);
	...
	function install(Vue) {
	  ...
	  Vue.component('Croppie', component);
	}
